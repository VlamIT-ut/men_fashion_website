				...
				<footer class="bg3 p-t-75 p-b-32">
					...
					<div class="p-t-40">
						...
						<p class="stext-107 cl6 txt-center">
							...
							Bản quyền &copy;
							<script>document.write(new Date().getFullYear());</script> Mọi quyền được bảo lưu | Giao
							diện được thiết kế
							bằng <i class="fa fa-heart-o" aria-hidden="true"></i> bởi <a href="https://colorlib.com"
